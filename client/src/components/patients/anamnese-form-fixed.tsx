...
import { anamneseSchema, type Anamnese } from "@shared/schema";
import { z } from "zod";

// Schema simplificado para o formulário
const anamneseFormSchema = anamneseSchema.omit({ 
  id: true, 
  companyId: true, 
  createdAt: true, 
  updatedAt: true,
...
export default function AnamneseFormFixed({ patientId }: AnamneseFormProps) {
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="medications">Tem alguma alergia conhecida?</Label>
                  <Textarea
                    id="allergies"
